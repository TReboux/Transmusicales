		...
		<div class="errors">
			...
			<div class="col-md-12">
				<div class="col-md-3">
					<label>Nom :</label>
					<?php
					echo '<input class="inp-s5 form-control" type="text" id="name" name="name" placeholder="Nom de la salle"';
				...
				<div class="col-md-2">
					...
					<select required name="capacite" class="inp-s5 form-control"/>
				...
				<div class="col-md-2">
					<label>De :</label>
					<select required name="heure_debut" class="inp-s5 form-control"/>
						<option value ="-1">/</option>
				...
				<div class="col-md-2">
					<label>A :</label>
					<select required name="heure_fin" class="inp-s5 form-control"/>
						<option value ="-1">/</option>
						<?php foreach ($horaires as $heure): ?>
						<option value ="<?php echo $heure ?>"><?php echo $heure."h"?></option>
						<?php endforeach?>
				...
				<div class="col-md-3">
					<label>Le :</label>
					<input class="inp-s5 form-control" type="date" id="debut" name="debut" placeholder="Date (JJ/MM/AAAA)"/>
				</div>
				<div class="col-md-3">
					<label>Accès handicapé :</label>
					<?php
					echo '<input type="checkbox" id="handicap" name="handicap"';
